...
SELECT
  ...
  ROUND(100.0 * SUM(CASE WHEN fase4_digitalizacion THEN 1 ELSE 0 END)::NUMERIC / NULLIF(COUNT(*), 0), 2) AS porcentaje_f4,
  ROUND(100.0 * SUM(CASE WHEN fase5_implementacion THEN 1 ELSE 0 END)::NUMERIC / NULLIF(COUNT(*), 0), 2) AS porcentaje_f5,
  ROUND(100.0 * SUM(CASE WHEN fase6_liberacion THEN 1 ELSE 0 END)::NUMERIC / NULLIF(COUNT(*), 0), 2) AS porcentaje_f6
FROM tramites;
